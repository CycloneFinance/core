...
export type ExampleJettonMaster$Data = {
    $$type: 'ExampleJettonMaster$Data';
    total_supply: bigint;
    mintable: boolean;
    owner: Address;
    jetton_content: Cell;
...
export function storeExampleJettonMaster$Data(src: ExampleJettonMaster$Data) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeCoins(src.total_supply);
        b_0.storeBit(src.mintable);
...
export function loadExampleJettonMaster$Data(slice: Slice) {
    let sc_0 = slice;
    let _total_supply = sc_0.loadCoins();
    let _mintable = sc_0.loadBit();
    let _owner = sc_0.loadAddress();
    let _jetton_content = sc_0.loadRef();
    return { $$type: 'ExampleJettonMaster$Data' as const, total_supply: _total_supply, mintable: _mintable, owner: _owner, jetton_content: _jetton_content };
}

function loadTupleExampleJettonMaster$Data(source: TupleReader) {
    let _total_supply = source.readBigNumber();
    let _mintable = source.readBoolean();
    let _owner = source.readAddress();
    let _jetton_content = source.readCell();
...
function loadGetterTupleExampleJettonMaster$Data(source: TupleReader) {
    let _total_supply = source.readBigNumber();
    let _mintable = source.readBoolean();
    let _owner = source.readAddress();
    let _jetton_content = source.readCell();
...
function storeTupleExampleJettonMaster$Data(source: ExampleJettonMaster$Data) {
    let builder = new TupleBuilder();
    builder.writeNumber(source.total_supply);
    builder.writeBoolean(source.mintable);
    builder.writeAddress(source.owner);
...
function dictValueParserExampleJettonMaster$Data(): DictionaryValue<ExampleJettonMaster$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeExampleJettonMaster$Data(src)).endCell());
        },
        parse: (src) => {
            return loadExampleJettonMaster$Data(src.loadRef().beginParse());
        }
    }
}
...
function dictValueParserPool$Data(): DictionaryValue<Pool$Data> {
 ...
 type ExampleJettonMaster_init_args = {
    $$type: 'ExampleJettonMaster_init_args';
    owner: Address;
    jetton_content: Cell;
}

function initExampleJettonMaster_init_args(src: ExampleJettonMaster_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeRef(src.jetton_content);
...
async function ExampleJettonMaster_init(owner: Address, jetton_content: Cell) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initExampleJettonMaster_init_args({ $$type: 'ExampleJettonMaster_init_args', owner, jetton_content })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const ExampleJettonMaster_errors: { [key: number]: { message: string } } = {
...
const ExampleJettonMaster_types: ABIType[] = [
    ...
    {"name":"ExampleJettonMaster$Data","header":null,"fields":[{"name":"total_supply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"mintable","type":{"kind":"simple","type":"bool","optional":false}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"jetton_content","type":{"kind":"simple","type":"cell","optional":false}}]},
...
export const ExampleJettonMaster_getterMapping: { [key: string]: string } = {
    'get_jetton_data': 'getGetJettonData',
    'get_wallet_address': 'getGetWalletAddress',
}

const ExampleJettonMaster_receivers: ABIReceiver[] = [
...
export class ExampleJettonMaster implements Contract {
    
    static async init(owner: Address, jetton_content: Cell) {
        return await ExampleJettonMaster_init(owner, jetton_content);
    }
    
    static async fromInit(owner: Address, jetton_content: Cell) {
        const init = await ExampleJettonMaster_init(owner, jetton_content);
        const address = contractAddress(0, init);
        return new ExampleJettonMaster(address, init);
    }
    
    static fromAddress(address: Address) {
        return new ExampleJettonMaster(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  ExampleJettonMaster_types,
        getters: ExampleJettonMaster_getters,
        receivers: ExampleJettonMaster_receivers,
        errors: ExampleJettonMaster_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'Mint:1' | JettonBurnNotification | JettonMint | Deploy) {
