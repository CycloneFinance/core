...
export function loadFactory$Data(slice: Slice) {
    ...
    return { $$type: 'Factory$Data' as const, id: _id, counter: _counter };
}
...
async function Factory_init(id: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const Factory_types: ABIType[] = [
    ...
    {"name":"Factory$Data","header":null,"fields":[{"name":"id","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"counter","type":{"kind":"simple","type":"uint","optional":false,"format":32}}]},
]
